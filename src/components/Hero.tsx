export default function Hero() {
    return (
      <>
      <div className="h-160 md:h-screen w-full flex relative overflow-hidden mt-30 md:mt-0">
        ...
        <img src="./hero.png" className="select-none pointer-events-none absolute left-1/2 -translate-x-1/2 2xl:bottom-40 2xl:scale-150 xl:bottom-0 scale-150 bottom-25 md:scale-100" alt="" />
        <div className="md:w-76 w-50 absolute md:right-25 right-10 bottom-15 md:bottom-30  flex flex-col items-start gap-4">
